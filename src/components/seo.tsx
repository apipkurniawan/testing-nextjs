...
const defaultMeta = {
  title: "Testing app",
  siteName: "Testing app",
  description: "Testing app",
  /** Without additional '/' on the end, e.g. https://google.com */
  url: `${process.env.NEXT_PUBLIC_OCEAN_GATEWAY_FE_URL}:3000`,
  type: "website",
  robots: "follow, index",
  /**
   ...
   */
  image: `${process.env.NEXT_PUBLIC_OCEAN_GATEWAY_FE_URL}/images/logo-text.png`,
};
